...
<body class="min-h-screen bg-gradient-to-r from-blue-200 to-green-200 flex items-center justify-center px-4">

<div class="bg-white rounded-2xl shadow-xl p-10 w-full max-w-xl text-center">
